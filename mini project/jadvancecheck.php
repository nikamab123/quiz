    ...
    //    echo "Success";
       ...
       if(isset($_POST['submit']))
       {
           if(!empty($_POST['quizcheck']))
           {
               ...
               echo"<br><br><div class='score'><center><h2>" . $_SESSION['username'] ." , Your Result in Java Advanced </center></h2></div><br><br>";
        ...
        $finalresult="update jgraph set Advanced='$result' where user='$name'";
