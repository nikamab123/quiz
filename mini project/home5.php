<?php
    ...
    $query = $db->query("SELECT * FROM `questions` ORDER BY RAND() LIMIT 4");
    ...
    if(!isset($_SESSION['qid']) && $question != 1){
    $msg = "Sorry! No cheating.";
    header("location:home5.php?msg=$msg");
    exit();
    }
    if(isset($_SESSION['qid']) && in_array($question, $_SESSION['qid'])){
